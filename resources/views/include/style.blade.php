...
<script type="text/javascript" src="{{asset('js/proses_data_ki_komunal.js')}}"></script>
...
<!-- /theme JS files -->
<script type="text/javascript" src="{{asset('assets/js/pages/layout_sidebar_sticky_custom.js')}}"></script> 
<style type="text/css">
	.table tbody tr td {
