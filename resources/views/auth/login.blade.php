...
<head>
    ...
    <style>
        ...
        #log_password+.glyphicon,
        #forg_password+.glyphicon,
        #forg_password_confirm+.glyphicon {
            cursor: pointer;
            pointer-events: all;
            transition: all .3s ease-in-out;
        }

        #log_password+.glyphicon:hover,
        #forg_password+.glyphicon:hover,
        #forg_password_confirm+.glyphicon:hover {
...
<body class="use-nicescroll">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input id="useremail" type="text" class="form-control" name="username"
                                        tabindex="1" placeholder="Masukkan NIK Anda" value="{{ old('useremail') }}"
                                        required autofocus>
                                ...
                                <div class="form-group">
                                    <a href="{{ url('/berandapage') }}" class="btn btn-info btn-lg btn-block"
                                        tabindex="4">Kembali Ke Halaman Depan
                                    </a>
                                </div>

                                <div class="form-group">
                                    <a href="{{ url('/register') }}" class="btn btn-warning btn-lg btn-block"
                                        tabindex="4">DAFTAR
                                    </a>
                                </div>
                            </form>
    ...
    <script>
        ...
        function progress() {
            ...
            var $bgColor = progress > 99 ? '{{ !is_null($color) ? $color->light : '#00ae80' }}' :
                '{{ !is_null($color) ? $color->main : '#009D73' }}';
            var $textColor = progress > 99 ? '#fff' : '#333';

            $('.progress .bar').width(progress + '%').css({
                backgroundColor: $bgColor
            });
            // $('h1').text(Math.round(progress) + '%').css({color: $textColor});
            $('.fill').height(progress + '%').css({
                backgroundColor: $bgColor
            });
        }
