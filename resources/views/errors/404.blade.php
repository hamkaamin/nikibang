...
<body>
<h1>404 ERROR &ndash; HALAMAN TIDAK DITEMUKAN</h1>
<p class="zoom-area">Halaman yang Anda cari mungkin telah dihapus, namanya diubah atau untuk sementara tidak
    tersedia.</p>
...
<div class="link-container">
    <a href="{{route('beranda')}}" class="more-link">Alihkan saya ke halaman Beranda!</a>
</div>
</body>
</html>
