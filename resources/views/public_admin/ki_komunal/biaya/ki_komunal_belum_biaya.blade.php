	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				{{-- <div>
					<a class="btn btn-info" onclick="tambah_modal_ki_komunal('{{csrf_token()}}', '#ModalBiru')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div> --}}
				<br>
				<div class="">
					<table class="table table-bordered table-hover datatable-basic">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$r['nama']}}</td>    
								@if(Auth::user()->role_id == 1)
								<td ><span onclick="stat_verif_ki_komunal_tidak_dibiayai('{{csrf_token()}}', '{{$r->id}}')" style="cursor: pointer;" class="label bg-warning label-rounded">Tidak Dibiayai</span></td>   
