            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tabtabtab">
                        <!--  -->
                        <form id="formVerifPembayaranTransaksiBeli" class="form-horizontal" method="post" action="{{url('admin/simpan_verifikasi_ki_komunal_pembiayaan')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="ki_komunal_id" id="ki_komunal_id" value="{{$data_ki_komunal->id}}">
                            <?php
                            $lunas = '';
                            if($data_ki_komunal->is_biaya == 1){
                                $lunas = 'checked';
                            }
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"> 
                                    <textarea class="form-control input-xs" id="keterangan" name="keterangan" rows="3" style="resize: none;" required="required">{{$data_ki_komunal->ket_biaya}}</textarea>  
                                </div>
                            </div>
