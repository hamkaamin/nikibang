            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <div class="modal-body">
                        <form id="formTambahUsulanStaffPindahArsip" method="post" action="{{ route('simpan_cipta') }}" class="form-horizontal steps-validation" enctype="multipart/form-data" >
                            {{ csrf_field() }}


                            <h6>Data Hak Cipta</h6>
                            <fieldset>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="text" class="form-control required" placeholder="Masukkan Nomor Pencatatan" name="nomor_pencatatan" id="nomor_pencatatan" required="required">  
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="date" class="form-control required" value="<?= date('Y-m-d') ?>" name="tanggal_pencatatan" id="tanggal_pencatatan" required="required">  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <select name="status_cipta" id="status_cipta" data-placeholder="Member" class="form-control select">
                                                    ...
                                                    <option value="1">(PA) Diberi Hak Cipta</option>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="date" placeholder="Masukkan Jenis Hak Cipta Anda" class="form-control" name="tanggal_permohonan" id="tanggal_permohonan">
                                            </div>
                                        </div>  
                                    </div>
                                    <div class="col-md-6">
