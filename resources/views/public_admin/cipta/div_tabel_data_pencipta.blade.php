...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmPencipta').toggle(500);">
...
<form style="display: none;" id="frmPencipta" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_pencipta('{{csrf_token()}}', '{{ $id }}', '.btn_data_pencipta');
    return false;
">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_pencipta"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="hapus_data_pencipta('{{csrf_token()}}','{{ $id_prioritas }}','{{$id}}')"
