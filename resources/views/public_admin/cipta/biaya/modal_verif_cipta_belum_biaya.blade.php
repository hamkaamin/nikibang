            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tabtabtab">
                        <!--  -->
                        <form id="formVerifPembayaranTransaksiBeli" class="form-horizontal" method="post" action="{{url('admin/simpan_verifikasi_cipta_pembiayaan')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="cipta_id" id="cipta_id" value="{{$data_cipta->id}}">
                            <?php
                            $lunas = '';
                            if($data_cipta->is_biaya == 1){
                                $lunas = 'checked';
                            }
                            ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"> 
                                    <textarea class="form-control input-xs" id="keterangan" name="keterangan" rows="3" style="resize: none;" required="required">{{$data_cipta->ket_biaya}}</textarea>  
                                </div>
                            </div>
