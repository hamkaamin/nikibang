...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmPemegang_cipta').toggle(500);">
...
<form style="display: none;" id="frmPemegang_cipta" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_pemegang_cipta('{{csrf_token()}}', '{{ $id }}', '.btn_data_pemegang_cipta');
    return false;
">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_pemegang_cipta"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            ?>
                            @foreach ($data_pemegang_cipta as $r) 
                            @php
                            $no ++;
                            $id_pemegang = $r['id'];
                            @endphp
                            <tr>
                                ...
                                <td>  
                                    <button type="button" onclick="hapus_data_pemegang_cipta('{{csrf_token()}}','{{ $id_pemegang }}','{{$id}}')"
