                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                <label for="nama" style="text-align: right;" class="col-lg-3 control-label">
                                    Nama Pemilik <span style="color:red"><b>*</b></span> : 
                                </label>
                                <div class="col-lg-8"> 
                                    <input type="text" placeholder="Nama Pemilik" class="form-control" value="{{$data_pemilik['nama']}}" name="nama" id="nama" >  
                                </div>
                            </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($r->id == $data_pemilik->countries_id)
