        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_prioritas_paten_ubah', $data_prioritas_paten->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" class="form-control" value="{{$data_prioritas_paten['nomor']}}" name="nomor" id="nomor" >  
                                </div>
                            </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="date" class="form-control" value="{{$data_prioritas_paten['tanggal']}}" name="tanggal" id="tanggal" >  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap">
                                <label for="keterangan" style="text-align: right;" class="col-lg-3 control-label">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($r->id == $data_prioritas_paten->countries_id)
