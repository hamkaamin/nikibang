        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_kelas_locarno') }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input type="text" placeholder="Kode Kelas Locarno" class="form-control" value="" name="kode" id="kode" >  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
