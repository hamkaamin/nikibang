        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_pencipta_ubah', $data_pencipta->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input type="text" placeholder="Nama Pencipta" class="form-control" value="{{$data_pencipta['nama']}}" name="nama" id="nama" >  
                                </div>
                            </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($r->id == $data_pencipta->countries_id)
