                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <p><b>{{$data_merek->nomor_pendaftaran}}</b></p>  
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                            <p><b>{{$data_merek['tanggal_pendaftaran']}}</b></p>  
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                            <p><b>{{$data_merek['tanggal_pengumuman']}}</b></p> 
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8"> 
                                                <?php  
                                                $translasi=str_ireplace('<p>','',$data_merek->translasi);
                                                $translasi2=str_ireplace('</p>','',$translasi);  
                                                ?>
                                                <p><b>
                                                    <?=$translasi2;?></b></p>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <p><b>{{$data_merek['nomor_pengumuman']}}"</b></p> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <p><b>{{$data_merek['nomor_permohonan']}}</b></p> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <p><b>{{$data_merek['tanggal_penerimaan']}}</b></p> 
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <p><b>{{$data_merek['tanggal_perlindungan']}}</b></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <p><b>{{$data_merek['tanggal_end_perlindungan']}}</b></p> 
                                            </div>
                                        </div>  
                                    </div>  
                                </div>
