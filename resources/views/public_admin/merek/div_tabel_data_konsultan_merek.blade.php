...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmKonsultan_merek').toggle(500);">
...
<form style="display: none;" id="frmKonsultan_merek" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_konsultan_merek('{{csrf_token()}}', '{{ $id }}', '.btn_data_konsultan_merek');
    return false;
">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_konsultan_merek"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            ?>
                            @foreach ($data_konsultan_merek as $r) 
                            @php
                            $no ++;
                            $id_konsultan = $r['id'];
                            @endphp
                            <tr>
                                ...
                                <td>  
                                    <button type="button" onclick="hapus_data_konsultan_merek('{{csrf_token()}}','{{ $id_konsultan }}','{{$id}}')"
