...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmKelas').toggle(500);">
...
<form style="display: none;" id="frmKelas" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_kelas('{{csrf_token()}}', '{{ $id }}', '.btn_data_kelas');
    return false;
">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_kelas"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{$r['jenis']}}</td>  
								<td>
									<button type="button" onclick="hapus_data_kelas('{{csrf_token()}}','{{ $id_prioritas }}','{{$id}}')"
