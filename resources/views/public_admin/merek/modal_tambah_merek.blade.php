            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <div class="modal-body">
                        <form id="formTambahUsulanStaffPindahArsip" method="post" action="{{ route('simpan_merek') }}" class="form-horizontal steps-validation" enctype="multipart/form-data" >
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea style="font-weight: bold; font-family: Arial;" name="translasi" id="translasi" rows="4"class="form-control summernote"></textarea>
                                            </div>
                                        </div> 
                                    </div> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input placeholder="Masukkan Nama Merek" type="text" class="form-control required" name="nama_merek" id="nama_merek" required="required"> 
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="date" placeholder="Masukkan Jenis Merek Anda" class="form-control" name="tanggal_perlindungan" id="tanggal_perlindungan" required="">
                                            </div>
                                        </div>
