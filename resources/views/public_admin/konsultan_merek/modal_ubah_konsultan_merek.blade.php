        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_konsultan_merek_ubah', $data_konsultan_merek->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" class="form-control" placeholder="Nama Konsultan" value="{{$data_konsultan_merek['nama']}}" name="nama" id="nama" >  
                                </div>
                            </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($r->id == $data_konsultan_merek->countries_id)
