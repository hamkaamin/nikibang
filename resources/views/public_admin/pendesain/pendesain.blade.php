	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Master Data Pendesain </h6>
			...
			<div class="panel-body">
				<div>
					<a class="btn btn-info" onclick="tambah_modal_pendesain('{{csrf_token()}}', '#ModalBiruSm')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div>
				<br>
				<div class="">
						...
						<tbody>
							...
							<tr>
								...
								<td>  
									...
									edit_modal_pendesain('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
									" id="modal_update_pendesain" class="btn bg-teal-400 btn-xs btn-block">
									<i class="glyphicon glyphicon-edit"></i></button> 
									<button type="button" onclick="hapus_data_pendesain('{{csrf_token()}}','{{ $id }}')"
