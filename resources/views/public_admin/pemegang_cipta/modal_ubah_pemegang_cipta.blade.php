        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_pemegang_cipta_ubah', $data_pemegang_cipta->id) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" class="form-control" placeholder="Nama Pemegang" value="{{$data_pemegang_cipta['nama']}}" name="nama" id="nama" >  
                                </div>
                            </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    ...
                                    @if($r->id == $data_pemegang_cipta->countries_id)
