...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmPemegang_desain').toggle(500);">
...
<form style="display: none;" id="frmPemegang_desain" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_pemegang_desain('{{csrf_token()}}', '{{ $id }}', '.btn_data_pemegang_desain');
    return false;
">
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input placeholder="Nama Pemegang" type="text" class="form-control" value="" name="nama" id="nama" >  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_pemegang_desain"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            ?>
                            @foreach ($data_pemegang_desain as $r) 
                            @php
                            $no ++;
                            $id_pemegang = $r['id'];
                            @endphp
                            <tr>
                                ...
                                <td>  
                                    <button type="button" onclick="hapus_data_pemegang_desain('{{csrf_token()}}','{{ $id_pemegang }}','{{$id}}')"
