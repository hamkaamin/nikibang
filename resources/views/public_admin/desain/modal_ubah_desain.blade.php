                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="text" class="form-control required" placeholder="Masukkan Nomor Pendaftaran" name="nomor_pendaftaran" value="{{$data_desain->nomor_pendaftaran}}" id="nomor_pendaftaran" required="required">  
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="date" class="form-control required" value="{{$data_desain['tanggal_pendaftaran']}}"  name="tanggal_pendaftaran" id="tanggal_pendaftaran" required="required">  
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="date" class="form-control required" value="{{$data_desain['tanggal_pengumuman']}}" name="tanggal_pengumuman" id="tanggal_pengumuman">  
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <select name="status_desain" id="status_desain" data-placeholder="Member" class="form-control select">
                                                    ...
                                                    <option selected="" value="1">(PA) Diberi Hak Desain Industri</option>
                                                ...
                                                @elseif($data_desain['status'] == 2)
                                                    <option value="0">-- Tampilkan Semua --</option> 
                                                    <option value="1">(PA) Diberi Desain</option>
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea style="font-weight: bold; font-family: Arial;" name="kegunaan_produk" id="kegunaan_produk" rows="4"class="form-control summernote">{{$data_desain['kegunaan_produk']}}</textarea>
                                            </div>
                                        </div> 
                                    </div> 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="text" placeholder="Masukkan Nomor Pengumuman" class="form-control" value="{{$data_desain['nomor_pengumuman']}}" name="nomor_pengumuman" id="nomor_pengumuman">  
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" placeholder="Masukkan Nomor Permohonan Anda" class="form-control" value="{{$data_desain['nomor_permohonan']}}" name="nomor_permohonan" id="nomor_permohonan">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7"> 
                                                <input type="date" class="form-control" value="{{$data_desain['tanggal_penerimaan']}}" name="tanggal_penerimaan" id="tanggal_penerimaan">  
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6"> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input placeholder="Masukkan Nama Desain Industri" type="text" class="form-control required" name="nama_desain" value="{{$data_desain->nama}}" id="nama_desain" required="required"> 
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="date" placeholder="Masukkan Jenis Desain Industri Anda" class="form-control" name="tanggal_perlindungan" value="{{$data_desain['tanggal_perlindungan']}}" id="tanggal_perlindungan" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="date" placeholder="Masukkan Tanggal Perlindungan Anda" class="form-control" value="{{$data_desain['tanggal_end_perlindungan']}}" name="tanggal_end_perlindungan" id="tanggal_end_perlindungan">
                                            </div>
                                        </div> 
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea style="font-weight: bold; font-family: Arial;" name="deskripsi" id="deskripsi" rows="4"class="form-control summernote">{{$data_desain['deskripsi_klaim']}}</textarea>
                                            </div>
                                        </div> 
                                    </div> 
