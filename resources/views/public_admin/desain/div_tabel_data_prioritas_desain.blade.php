...
<div class="row">
    <div class="col-md-12">  
        <button type="button" class="btn btn-primary" onclick="$('#frmPrioritas_desain').toggle(500);">
...
<form style="display: none;" id="frmPrioritas_desain" class="form-horizontal"  enctype="multipart/form-data" onsubmit="
    simpan_div_data_prioritas_desain('{{csrf_token()}}', '{{ $id }}', '.btn_data_prioritas_desain');
    return false;
">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn_data_prioritas_desain"><i class="icon-check"></i> Simpan</button>
                        </div>
                    </form>
<table class="table table-bordered table-hover datatable-basic">
						...
						<tbody>
							...
							$no = 0;
							?>
							@foreach ($data_prioritas_desain as $r) 
							@php 
							$no ++;
							$id_prioritas = $r['id'];
							@endphp
							<tr>
								...
								<td>
									<button type="button" onclick="hapus_data_prioritas_desain('{{csrf_token()}}','{{ $id_prioritas }}','{{$id}}')"
