	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Master Data Konsultan Cipta </h6>
			...
			<div class="panel-body">
				<div>
					<a class="btn btn-info" onclick="tambah_modal_konsultan_cipta('{{csrf_token()}}', '#ModalBiruSm')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div>
				<br>
				<div class="">
						...
						<tbody>
							...
							<tr>
								...
								<td>  
									...
									edit_modal_konsultan_cipta('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
									" id="modal_update_konsultan_cipta" class="btn bg-teal-400 btn-xs btn-block">
									<i class="glyphicon glyphicon-edit"></i></button> 
									<button type="button" onclick="hapus_data_konsultan_cipta('{{csrf_token()}}','{{ $id }}')"
