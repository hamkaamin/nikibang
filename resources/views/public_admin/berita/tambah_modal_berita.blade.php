                    ...
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_berita') }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="file" class="form-control" value="" name="file_upload" id="file_upload" >  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap">
                                <label for="nama" style="text-align: right;" class="col-lg-3 control-label">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" class="form-control" value="" name="kategori" id="kategori" >  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
