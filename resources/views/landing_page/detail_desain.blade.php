                        ...
                        <div class="px-3 mb-4">
                            <div class="card border-0 border-radius-0 mb-5 box-shadow-1">
                                <div class="card-body p-4 z-index-1">
                                    ...
                                    $no=0;
                                    @endphp
                                    @foreach($detail_data->upload_desain as $r)@php 
                                    $no++;
                                    @endphp
                            ...
                            <div class="card-body p-4 z-index-1">
                                <div class="card-body p-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">{!! $detail_data->kegunaan_produk !!}</div>
                                    </div>
                                    <hr class="my-2"> 
                                    <div class="row">
                                        <div class="col-sm-3 font-weight-bold" style="font-size: 15pt">
                                        ...
                                        <div class="col-sm-9">{!! $detail_data->deskripsi_klaim !!}</div>
                                    </div>
                                    <hr class="my-2">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <table class="table table-hovered">
                                                ...
                                                <tbody>
                                                    @foreach($detail_data->pemegang as $r)
                                                    <tr>
                                                        <td>{{ $r->nama }}</td>
                                                        <td>{{ $r->alamat }}</td>
                                                        <td>{{ $r->countries->alpha_2_code }} - {{ $r->countries->nationality }}</td>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <table class="table table-hovered">
                                                ...
                                                <tbody>
                                                    @foreach($detail_data->pendesain as $r)
                                                    <tr>
                                                        <td>{{ $r->nama }}</td>
                                                        <td>{{ $r->alamat }}</td>
                                                        <td>{{ $r->countries->alpha_2_code }} - {{ $r->countries->nationality }}</td>
