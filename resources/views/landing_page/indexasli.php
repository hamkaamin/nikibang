...
<div role="main" class="main">
		...
		<div class="container position-relative z-index-1 pt-5 mt-5">
			...
			<div class="row align-items-center pt-4">
				...
				<div class="col-md-6 pb-5">
					<img src="{{ asset('assets_landing/img/demos/seo-2/concept-1.png') }}" class="img-fluid position-relative z-index-1 scale-1 pb-5 mb-5 ml-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="Demo SEO 2" />
				</div>
			</div>
		</div>
	</section>
					...
					<div class="row align-items-center">
						<div class="col-md-6">
							<div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="850">
								<div class="custom-dots-rect-1" style="background-image: url(<?php echo asset('assets_landing/img/demos/seo-2/dots-group.png'); ?>);"></div>
								<div class="card-body text-center pt-5">
									<img src="{{ asset('assets_landing/img/demos/seo-2/icons/target.svg') }}" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}" />
							...
							<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4">
								<div class="card-body text-center pt-5">
									<img src="{{ asset('assets_landing/img/demos/seo-2/icons/search.svg') }}" class="img-fluid mb-4 pb-2" width="80" height="80" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}" />
						...
						<div class="col-md-6">
							<div class="card position-relative border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">
								<div class="custom-dots-rect-2" style="background-image: url(<?php echo asset('assets_landing/img/demos/seo-2/dots-group-2.png'); ?>);"></div>
								<div class="card-body text-center pt-5">
									<img src="{{ asset('assets_landing/img/demos/seo-2/icons/teaching.svg') }}" class="img-fluid mb-4 pb-2" width="70" height="70" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-tertiary pb-2 mb-4'}" />
		...
		<div class="container position-relative z-index-1 mt-3 mb-5">
			...
			<div class="row text-center align-items-center pb-4 pt-lg-4 mb-3 mb-lg-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="300">
				<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
					<img src="{{ asset('assets_landing/img/logos/logo-8.png') }}" class="img-fluid" alt="" style="max-width: 90px;" />
				</div>
				<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
					<img src="{{ asset('assets_landing/img/logos/logo-9.png') }}" class="img-fluid" alt="" style="max-width: 130px;" />
				</div>
				<div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
					<img src="{{ asset('assets_landing/img/logos/logo-10.png') }}" class="img-fluid" alt="" style="max-width: 130px;" />
				</div>
				<div class="col-md-4 col-lg-2 mb-4 mb-md-0">
					<img src="{{ asset('assets_landing/img/logos/logo-11.png') }}" class="img-fluid" alt="" style="max-width: 130px;" />
				</div>
				<div class="col-md-4 col-lg-2 mb-4 mb-md-0">
					<img src="{{ asset('assets_landing/img/logos/logo-12.png') }}" class="img-fluid" alt="" style="max-width: 120px;" />
				</div>
				<div class="col-md-4 col-lg-2">
					<img src="{{ asset('assets_landing/img/logos/logo-13.png') }}" class="img-fluid" alt="" style="max-width: 130px;" />
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 text-center text-lg-left">
					<img src="{{ asset('assets_landing/img/demos/seo-2/concept-2.png') }}" class="img-fluid appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600" alt="" />
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-center pb-2 mb-4">
				<div class="col-md-7 col-lg-4 mb-4 mb-lg-0">
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
						<div class="custom-dots-rect-3" style="background-image: url(<?php echo asset('assets_landing/img/demos/seo-2/dots-group-3.png'); ?>);"></div>
					...
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-plugin-options="{'accY': -100}">
						<div class="card-body text-center p-5">
							<img src="{{ asset('assets_landing/img/demos/seo-2/icons/icon-4.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
				...
				<div class="col-md-7 col-lg-4 pt-lg-4 mt-lg-5 mb-4 mb-lg-0">
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
						<div class="card-body text-center p-5">
							<img src="{{ asset('assets_landing/img/demos/seo-2/icons/icon-2.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
					...
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="250">
						<div class="card-body text-center p-5">
							<img src="{{ asset('assets_landing/img/demos/seo-2/icons/icon-5.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
				...
				<div class="col-md-7 col-lg-4">
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
						<div class="card-body text-center p-5">
							<img src="{{ asset('assets_landing/img/demos/seo-2/icons/icon-3.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
					...
					<div class="card border-0 custom-box-shadow-1 custom-border-radius-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500" data-plugin-options="{'accY': -100}">
						<div class="card-body text-center p-5">
							<img src="{{ asset('assets_landing/img/demos/seo-2/icons/icon-6.png') }}" class="img-fluid mb-4 mt-3 pb-3" width="55" alt="" />
	...
	<div class="container position-relative pb-lg-5 mb-5">
		...
		<div class="custom-dots-rect-4" style="background-image: url(<?php echo asset('assets_landing/img/demos/seo-2/dots-group.png'); ?>);"></div>
				...
				<div class="owl-carousel custom-carousel-style-1 custom-carousel-dots-style-1" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 0, 'loop': true, 'dots': true, 'nav': false, 'autoplay': true}">
						...
						<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
							...
							<div class="testimonial-author">
								<div class="testimonial-author-thumbnail">
									<img src="{{ asset('assets_landing/img/clients/client-1.jpg') }}" class="img-fluid rounded-circle" alt="">
								</div>
					...
					<div>
						<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
							...
							<div class="testimonial-author">
								<div class="testimonial-author-thumbnail">
									<img src="{{ asset('assets_landing/img/clients/client-2.jpg') }}" class="img-fluid rounded-circle" alt="">
								</div>
					...
					<div>
						<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
							...
							<div class="testimonial-author">
								<div class="testimonial-author-thumbnail">
									<img src="{{ asset('assets_landing/img/clients/client-3.jpg') }}" class="img-fluid rounded-circle" alt="">
								</div>
								<p><strong class="font-weight-semibold text-4 mb-1">John Smith</strong><span class="text-2">CEO</span></p>
							</div>
						</div>
					...
					<div>
						<div class="testimonial testimonial-style-3 custom-testimonial-style-1">
							...
							<div class="testimonial-author">
								<div class="testimonial-author-thumbnail">
									<img src="{{ asset('assets_landing/img/clients/client-4.jpg') }}" class="img-fluid rounded-circle" alt="">
								</div>
								<p><strong class="font-weight-semibold text-4 mb-1">John Doe</strong><span class="text-2">MARKETING</span></p>
							</div>
						</div>
			...
			<div class="row pricing-table custom-pricing-table-style-1 justify-content-center mb-4">
				<div class="col-md-8 col-lg-4">
					<div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
						<div class="custom-dots-rect-5" style="background-image: url(<?php echo asset('assets_landing/img/demos/seo-2/dots-group.png'); ?>);"></div>
								...
								<div class="card border-0 border-radius-0 box-shadow-1">
									<div class="card-body p-4 z-index-1">
										<a href="demo-seo-2-blog-post.html">
											<img class="card-img-top border-radius-0" src="{{ asset('assets_landing/img/demos/seo-2/blog/blog-1.jpg') }}" alt="Card Image">
										</a>
										...
										<div class="card-body p-0">
											...
											<a href="demo-seo-2-blog-post.html" class="font-weight-bolder text-uppercase text-decoration-none d-block mt-3">Read More +</a>
										</div>
									</div>
								</div>
							</article>
						...
						<div class="col-lg-6">
							<article>
								<div class="card border-0 border-radius-0 box-shadow-1">
									<div class="card-body p-4 z-index-1">
										<a href="demo-seo-2-blog-post.html">
											<img class="card-img-top border-radius-0" src="{{ asset('assets_landing/img/demos/seo-2/blog/blog-2.jpg') }}" alt="Card Image">
										</a>
										<p class="text-uppercase text-1 mb-3 pt-1 text-color-default"><time pubdate datetime="2020-01-10">10 Jan 2020</time> <span class="opacity-3 d-inline-block px-2">|</span> 3 Comments <span class="opacity-3 d-inline-block px-2">|</span> John Doe</p>
										<div class="card-body p-0">
