...
<div role="main" class="main"> 
    ...
    <?php 
    $sliders='';
    foreach($data_sliders as $r){
    $sliders= $r['path_file']; 
    } 
    ?>

          <div class="mySlides"> 
              <img src="{{asset('assets/slider/'.$sliders)}}" style="width:100%"> 
          </div> 
                        ...
                        <div class="row pricing-table custom-pricing-table-style-1 justify-content-center mb-4">
                            ...
                            <div class="col-md-8 col-lg-3">
                                <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                                    ...
                                    <div class="plan-features px-4">
                                        <img src="{{asset('assets_landing/img/newspaper.png')}}" style="width: 200px;height: 200px;">
                                    </div>
                                    <div class="plan-footer pt-3 pb-5">
                            ...
                            <div class="col-md-8 col-lg-3">
                                <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                                    ...
                                    <div class="plan-footer pt-3 pb-5">
                                        <a href="{{ url('/landing_pembiayaan_cipta') }}" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">MASUK</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8 col-lg-3">
                                <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                                    ...
                                    <div class="plan-footer pt-3 pb-5">
                                        <a href="{{ url('/landing_pembiayaan_paten') }}" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">MASUK</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-lg-3">
                                <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                                    <div class="custom-dots-rect-5" style="background-image: url(img/demos/seo-2/dots-group.png);"></div>
                                    <div class="plan-header bg-color-light pt-5 px-4">
                                        <h4 class="text-color-dark font-weight-bold text-color-quaternary text-5 mt-4 mb-2">Drafting KI Komunal</h4> 
                                    </div>
                                    <div class="plan-features px-4">
                                        <img src="{{asset('assets_landing/img/indeks-geografis.png')}}" style="width: 200px;height: 200px;">
                                    </div>
                                    <div class="plan-footer pt-3 pb-5">
                                        <a href="{{ url('/landing_drafting_komunal') }}" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">MASUK</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 col-lg-3">
                                <div class="plan text-center appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="550">
                                    <div class="custom-dots-rect-5" style="background-image: url(img/demos/seo-2/dots-group.png);"></div>
                                    <div class="plan-header bg-color-light pt-5 px-4">
                                        <h4 class="text-color-dark font-weight-bold text-color-quaternary text-5 mt-4 mb-2">Pembiayaan KI Komunal</h4> 
                                    </div>
                                    <div class="plan-features px-4">
                                        <img src="{{asset('assets_landing/img/ki-cash.jpg')}}" style="width: 200px;height: 200px;">
                                    </div>
                                    <div class="plan-footer pt-3 pb-5">
                                        <a href="{{ url('/landing_pembiayaan_ki_komunal') }}" class="btn btn-secondary btn-outline btn-rounded font-weight-semibold px-5 py-3 text-3 mb-4">MASUK</a>
                                    </div>
                                </div>
                            </div>
                            @endif
