                        ...
                        <div class="card border-0 border-radius-0 mb-5 box-shadow-1">
                            <div class="card-body z-index-1">
                                <div class="card-body p-0"> 
                                    <a href="{{ url('/landing_drafting_cipta') }}">
                                    ...
                                    <br>
                                    <div id="divDrafting">
                                        <form class="form-horizontal" method="post" action="{{ route('simpan_drafting_cipta_ubah', $data_cipta->id) }}" enctype="multipart/form-data" > 
                                        {{ csrf_field() }}
                                        ...
                                        <div class="row mb-5 ml-1">
                                            <div class="col-sm-2 font-weight-bold"> 
                                                Nomor Pencatatan : <span style="color:red"><b>*</b></span> 
                                            </div>
                                            <div class="col-sm-3">   
                                               <input type="text" class="form-control required" placeholder="Masukkan Nomor Pencatatan" value="{{$data_cipta['nomor_pencatatan']}}" name="nomor_pencatatan" id="nomor_pencatatan" required="required"> 
                                            </div>

                                            <div class="col-sm-2 font-weight-bold"> 
                                                Tanggal Pencatatan :<span style="color:red"><b>*</b></span>  
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row mb-5 ml-1">
                                            <div class="col-sm-2 font-weight-bold"> 
                                                Nama Hak Cipta : <span style="color:red"><b>*</b></span>
                                            </div>
                                            <div class="col-sm-3">  
                                                <input placeholder="Masukkan Nama Hak Cipta" type="text" value="{{$data_cipta['nama']}}" class="form-control required" name="nama_cipta" id="nama_cipta" required="required">
                                            </div>

                                            <div class="col-sm-2 font-weight-bold"> 
                                                Tanggal Permohonan : <span style="color:red"><b>*</b></span>
                                            </div>
                                            <div class="col-sm-3">  
                                               <input type="date" placeholder="Masukkan Jenis Hak Cipta Anda" value="{{$data_cipta['tanggal_permohonan']}}" class="form-control" name="tanggal_permohonan" id="tanggal_permohonan">
                                            </div>
                                        </div> 
                                        <div class="row mb-5 ml-1">
                                            <div class="col-sm-2 font-weight-bold"> 
                                        ...
                                        <div class="row mb-5 ml-1">
                                            ...
                                            <div class="col-sm-8">  
                                                <textarea style="font-weight: bold; font-family: Arial;" name="uraian" id="uraian" rows="4"class="form-control summernote"> {!! $data_cipta['uraian_ciptaan'] !!}</textarea>
                                            </div> 
                                        </div> 
