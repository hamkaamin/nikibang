                        ...
                        <div class="col"> 
                            <div class="overflow-hidden">
                                <ul class="breadcrumb d-block text-center appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="800">
                                    <li><a href="{{url('/berandapage')}}">Home</a></li>
                                    <li class="active"><a href="{{url('/berita_page/1')}}">Berita</a></li>
                                </ul>
                            </div>
                            <div class="overflow-hidden mb-4">
                                <h1 class="d-block text-color-quaternary font-weight-bold line-height-3 text-center mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="1000">{{$detail_berita->judul}}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <article>
                                <div class="card border-0 border-radius-0 mb-5 box-shadow-1">
                                    <div class="card-body p-4 z-index-1">
                                        <p class="text-uppercase text-1 mb-3 pt-1 text-color-default"><i class="icon-calendar2"> <?= date("d-M-Y", strtotime($detail_berita->created_at))."\n"; ?></i> <span class="opacity-3 d-inline-block px-2">|</span> <i class="icon-eye8"></i>  <b>{{$detail_berita->visit}}</b> <i>DILIHAT</i> <span class="opacity-3 d-inline-block px-2">|</span><i class="icon-price-tag2"></i>   {{$detail_berita->kategori}}</p>

                                        <div class="post-image pb-4">
                                            <img class="card-img-top border-radius-0" src="{{asset($detail_berita->thumbnail)}}"  alt="Card Image">
                                        </div>

                                        <div class="card-body p-0">{!! $detail_berita->konten !!} 
                                        </div>
                                    </div>
                                </div>
                            </article>
                            ...
                            <aside class="sidebar"> 
                                <div class="px-3 mt-4">
                                    ...
                                    <ul class="nav nav-list flex-column mt-2 mb-0 p-relative right-9">
                                        <li class="nav-item"><a class="nav-link bg-transparent border-0" href="#">{{$detail_berita->kategori}}</a></li> 
                                    </ul>
                                </div>
                            </aside>
                        </div>
